const Newsletter = () => {
  return (
    <div className='wfull py-16 text-gray-600 px-4 border-b border-gray-300'>
      <div className='max-w-[1240px] mx-auto grid lg:grid-cols-3'>
        ...
        <div className='my-4'>
          <div className='flex flex-col sm:flex-row items-center justify between w-full'>
            ...
            />
            <button className='bg-orange-200 text-zinc- text-sm sm:text-base rounded-md font-medium w-[200px] ml-4 my-6 px-6 py-3 border border-gray-300'>
              Notify Us
            </button>
          </div>
